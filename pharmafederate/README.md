High-Level Architecture: PharmaFederate
...
Executive Summary: A reference architecture for cross-border drug safety monitoring. PharmaFederate enables pharmaceutical companies and health ministries to generate Real-World Evidence (RWE) from distributed, siloed patient data while maintaining strict HIPAA and GDPR compliance.
...
Describe the Federated Learning approach and the use of the OMOP CDM.
...
5. Quick Start (Dev Setup)
How to spin up a local "Coordinator" and two mock "Clinical Nodes" using Docker Compose.
